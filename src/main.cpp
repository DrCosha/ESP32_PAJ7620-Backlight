...
#define CT_DELTA 1                                  // шаг изменения цвета
#define BR_DELTA 5                                  // шаг изменения яркости   
...
void report_to_topicMQTT() { // --- пишем события и состояние в MQTT топик ---
  ...
  // TODO:  здесь еще нужно предусмотреть НЕ ВЫВОДИТЬ сообщения в MQTT при регулировании яркости/цветовой температуры с кнопки
